...
@XmlType(name = "ActorType", namespace = "urn:be:fgov:ejustice:ejustbox:core:v1", propOrder = {
    "quality",
    "name",
    "firstName",
    "personInOrganisation"
})
public class ActorType2
    extends IdentifierType
{
	...
	public ActorType2(String id, String type, String quality, String name) {
		super(id, type);
	...
	public String toString() {
		return "ActorType2 [id=" + super.id + ", type=" + super.type + ", quality=" + quality + ", name=" + name + ", firstName=" + firstName
