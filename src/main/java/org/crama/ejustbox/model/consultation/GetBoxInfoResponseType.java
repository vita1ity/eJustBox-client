    ...
    extends StatusResponseType
{
	...
	public String toString() {
		return "GetBoxInfoResponseType [status: " + super.status + ", nbrMessagesInStandBy=" + nbrMessagesInStandBy + ", nbrUnreadMessages="
				+ nbrUnreadMessages + ", currentSize=" + currentSize + ", maxSize=" + maxSize + "]";
	}
