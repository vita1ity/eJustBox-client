...
/**
 * eJustice SOA Response Type for Services that require a Pagination as input.
 * 
...
@XmlType(name = "PaginationResponseType", namespace = "urn:be:fgov:ejustice:commons:protocol:v1")
