...
/**
 * eJustice SOA Request Type for Services that require a Pagination as input.
 * 
...
@XmlType(name = "PaginationRequestType", namespace = "urn:be:fgov:ejustice:commons:protocol:v1")
