...
/**
 * eJustice SOA Response Type for Services that require a Pagination as input and a Status as output.
 * 
...
@XmlType(name = "PaginationStatusResponseType", namespace = "urn:be:fgov:ejustice:commons:protocol:v1")
